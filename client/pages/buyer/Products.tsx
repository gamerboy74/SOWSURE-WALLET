    ...
    <>
      ...
      <div className="p-4 max-w-7xl mx-auto">
        ...
        <DialogBox
          ...
          title={state.editingId ? "Edit Buy Request" : "Add New Buy Request"}
          footer={
            <>
              <button
                type="button"
        ...
        >
          <form id="buy-request-form" onSubmit={handleSubmit} className="space-y-4">
            <div>
          ...
          {state.productToDelete && (
            <div className="flex items-center space-x-3">
              ...
              <p className="text-gray-700">
                ...
                <span className="font-semibold">{state.productToDelete.name}</span>? This
