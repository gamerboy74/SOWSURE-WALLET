...
function Settings() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to save settings or stats"
      );
      notification.error(
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setSettings({
                    ...settings,
                    min_withdrawal: parseInt(e.target.value) || 0,
                  })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setSettings({
                    ...settings,
                    max_withdrawal: parseInt(e.target.value) || 0,
                  })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setPlatformStats({
                    ...platformStats,
                    registered_farmers: parseInt(e.target.value) || 0,
                  })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setPlatformStats({
                    ...platformStats,
                    daily_transactions: parseFloat(e.target.value) || 0,
                  })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setPlatformStats({
                    ...platformStats,
                    verified_buyers: parseInt(e.target.value) || 0,
                  })
                }
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
              />
