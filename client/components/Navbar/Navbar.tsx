...
const Navbar: React.FC<NavbarProps> = React.memo(({ isAuthenticated = false }) => {
  ...
  const setupUserData = useCallback(async () => {
    ...
    try {
      ...
      setProfilePhoto(farmerData.data?.profile_photo_url || buyerData.data?.profile_photo_url || null);
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <ProfileMenu onLogout={handleLogout} profilePhoto={profilePhoto} isLoading={isLoading} />
            {address && (
